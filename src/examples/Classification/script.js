...
const definition = 'Classification.gh'

// setup input change events
const score_slider = document.getElementById( 'rangeValue' )
score_slider.addEventListener( 'mouseup', onSliderChange, false )
score_slider.addEventListener( 'touchend', onSliderChange, false )


const lowest_checkbox = document.querySelector('input[id="RH_IN:LowestOnly"]');
lowest_checkbox.addEventListener( 'change', onSliderChange, false )
...
async function compute () {
  ...
  const data = {
    ...
    inputs: {
      'rangeValue': score_slider.valueAsNumber,

      'point': point,

      'RH_IN:LowestOnly': lowest_checkbox.checked,
    }
  }
